...
C         WRITE(9,*) J, N200, R200, M200, VDISP
 ...
 11      Q1 = RAN1(ISEMA)
         ...
         SENTHETA = SQRT(1.0 - COSTHETA**2)
         PHI = 2.*PI*RAN1(ISEMA)
C Criando halos sem rotação
       VX(I) = (1./SQRT(3.))*GASDEV(ISEMA,ISEMB)*VDISP*SENTHETA*COS(PHI)
       VY(I) = (1./SQRT(3.))*GASDEV(ISEMA,ISEMB)*VDISP*SENTHETA*SIN(PHI)
       VZ(I) = (1./SQRT(3.))*GASDEV(ISEMA,ISEMB)*VDISP*COSTHETA
...
C         WRITE(9,*) J,N200,R200,M200,VDISP,V1,V2,V3,V4,V5
          ...
          PRINT*, "N200,R200,M200,VDISP"
          WRITE(9,*) J,N200,R200,M200,VDISP         
