...
%DADOS DO TRABALHO
%****************************************************************************************************
\titulo{Indicador indireto de rotação em Aglomerados de Galáxias}
% \titleenglish{Latex class to work late Master's Degree or Doctorate\par PPGMC - UESC }
%\subtitulo{Subtítulo do trabalho}
\autor{Luenne Nailam Sousa Nascimento}
...
%****************************************************************************************************
\orientador{Prof. Dr. André Luis Batista Ribeiro}  %Se for orientadora utilize o comando\orientador[Orientadora:]{Nome da orientadora}
...
\datadefesa{23/02/2020} %Coloque  data de defesa
